...
/*
 * 문제 이름 : 명예의 전당 (1)
 * 문제 설명 : "명예의 전당"이라는 TV 프로그램에서는 매일 1명의 가수가 노래를 부르고, 시청자들의 문자 투표수로 가수에게 점수를 부여합니다. 매일 출연한 가수의 점수가 지금까지 출연 가수들의 점수 중 상위 k번째 이내이면 해당 가수의 점수를 명예의 전당이라는 목록에 올려 기념합니다. 
 ...
 * 입출력 예 : 3, [10, 100, 20, 150, 1, 100, 200], [10, 10, 10, 20, 20, 100, 100]
 * 입출력 예 : 4, [0, 300, 40, 300, 20, 70, 150, 50, 500, 1000], [0, 0, 0, 0, 20, 40, 70, 70, 150, 300]
...
public class exam49 {
	...
	public int[] solution(int k, int[] score) {
        ...
        for(int i : score) {
            ...
            if(index >= k) {
                answer[index] = rank.get(rank.size() - k);
            }else {
                answer[index] = rank.get(0);
            }
